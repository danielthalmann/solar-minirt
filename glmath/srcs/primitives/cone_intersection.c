...
// at the ends of the cone. t_ends[0] is the smallest of them.
//
static void	init_t_ends(t_ray *r, const t_cone *cyl, float *t_ends)
{
	float	tmp;
...
static float	check_height(t_ray *r, const t_cone *cyl, float t_sides[2])
{
	t_v3f	inters[2];
	float	t_ends[2];
	float	real_t;
